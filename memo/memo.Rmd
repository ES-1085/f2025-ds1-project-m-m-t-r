...
We included this plot because MMR is a key measure of how much energy fish can use for activity and survival, and this figure clearly shows how MMR changes across heatwave temperatures and seasons.

```{r final-boxplot-treatment-vs-MMR, fig.alt= "A boxplot of maximum metabolic rate by heatwave temperature, colored by season. The box shows the fish's maximum metabolic rate is lowest at 28 °C heatwaves and highest at 31 °C."}
...
### Final Plot 3: Time faceted: Seasonal graph looking at body weight vs metabolic rate

We included this graph because it shows how the relationship between hawkfish body weight and the use of oxygen can change during heatwaves. Our claim that heatwaves have a major impact on hawkfish physiology is supported by a comparison of winter and summer, which shows that metabolic processes change dramatically in the heat.

```{r bodyweight-mr-per-season, fig.alt= "The two scatterplots compare hawkfish body weight and metabolic rate in winter and summer. Winter points are loosely clustered with a shallow downward trend. Summer points show a wider spread and a much steeper slope, indicating stronger changes in metabolism during heat-stress conditions."}
