...
The boxplot shows how metabolic rate (MMR) changes across heatwave treatments, helping identify which temperatures lead to higher energy use. The scatterplot shows how body size relates to energy use (SDA) and whether this relationship differs by season, revealing seasonal patterns in metabolism.
